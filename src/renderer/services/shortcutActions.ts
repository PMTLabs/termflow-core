 ...
 * Ctrl+1-9 (tab-jump) and Ctrl+Shift+V (fixed secondary paste fallback).
 * A customizable action can never be assigned one of these (see design doc
 * §3 non-goals). Alt+Arrow was removed from this list when the pane-nav stub
 * was deleted: those keys now pass through to the terminal (word movement).
 */

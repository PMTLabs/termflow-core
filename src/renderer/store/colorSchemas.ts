...
export const COLOR_SCHEMAS: ColorSchema[] = [
  ...
  { id: 'default', name: 'Default', theme: DEFAULT_THEME },
  {
    ...
    id: 'campbell', name: 'Windows Terminal', theme: {
      background: '#0C0C0C', foreground: '#F2F2F2', cursor: '#FFFFFF', cursorAccent: '#000000',
      black: '#0C0C0C', red: '#C50F1F', green: '#13A10E', yellow: '#C19C00',
      blue: '#0037DA', magenta: '#881798', cyan: '#3A96DD', white: '#CCCCCC',
      brightBlack: '#9B9B9B', brightRed: '#E74856', brightGreen: '#16C60C', brightYellow: '#F9F1A5',
  ...
  },
  {
    ...
    id: 'dracula', name: 'Dracula', theme: {
      background: '#282A36', foreground: '#FDFDFC', cursor: '#F8F8F2', cursorAccent: '#282A36',
      black: '#21222C', red: '#FF5555', green: '#50FA7B', yellow: '#F1FA8C',
      blue: '#BD93F9', magenta: '#FF79C6', cyan: '#8BE9FD', white: '#F8F8F2',
      brightBlack: '#ADB6D0', brightRed: '#FF6E6E', brightGreen: '#69FF94', brightYellow: '#FFFFA5',
  ...
  },
  {
    ...
    id: 'nord', name: 'Nord', theme: {
      background: '#2E3440', foreground: '#F5F7FA', cursor: '#D8DEE9', cursorAccent: '#2E3440',
      black: '#3B4252', red: '#BF616A', green: '#A3BE8C', yellow: '#EBCB8B',
      blue: '#81A1C1', magenta: '#B48EAD', cyan: '#88C0D0', white: '#E5E9F0',
      brightBlack: '#BFC2C9', brightRed: '#BF616A', brightGreen: '#A3BE8C', brightYellow: '#EBCB8B',
  ...
  },
  {
    ...
    id: 'solarized-dark', name: 'Solarized Dark', theme: {
      background: '#002B36', foreground: '#E0E4E5', cursor: '#93A1A1', cursorAccent: '#002B36',
      black: '#073642', red: '#DC322F', green: '#859900', yellow: '#B58900',
      blue: '#268BD2', magenta: '#D33682', cyan: '#2AA198', white: '#EEE8D5',
      brightBlack: '#A4B4B8', brightRed: '#CB4B16', brightGreen: '#586E75', brightYellow: '#657B83',
  ...
  },
  {
    ...
    id: 'one-dark', name: 'One Dark', theme: {
      background: '#282C34', foreground: '#EAECEF', cursor: '#528BFF', cursorAccent: '#282C34',
      black: '#282C34', red: '#E06C75', green: '#98C379', yellow: '#E5C07B',
      blue: '#61AFEF', magenta: '#C678DD', cyan: '#56B6C2', white: '#ABB2BF',
      brightBlack: '#B4B8BE', brightRed: '#E06C75', brightGreen: '#98C379', brightYellow: '#E5C07B',
  ...
  },
  {
    ...
    id: 'gruvbox-dark', name: 'Gruvbox Dark', theme: {
      background: '#282828', foreground: '#FAF6EC', cursor: '#EBDBB2', cursorAccent: '#282828',
      black: '#282828', red: '#CC241D', green: '#98971A', yellow: '#D79921',
      blue: '#458588', magenta: '#B16286', cyan: '#689D6A', white: '#A89984',
      brightBlack: '#BBB2A8', brightRed: '#FB4934', brightGreen: '#B8BB26', brightYellow: '#FABD2F',
  ...
  },
  {
    ...
    id: 'monokai', name: 'Monokai', theme: {
      background: '#272822', foreground: '#FDFDFC', cursor: '#F8F8F0', cursorAccent: '#272822',
      black: '#272822', red: '#F92672', green: '#A6E22E', yellow: '#F4BF75',
      blue: '#66D9EF', magenta: '#AE81FF', cyan: '#A1EFE4', white: '#F8F8F2',
      brightBlack: '#B5B2A8', brightRed: '#F92672', brightGreen: '#A6E22E', brightYellow: '#F4BF75',
  ...
  },
  {
    ...
    id: 'ubuntu', name: 'Ubuntu (WSL)', theme: {
      ...
      brightBlack: '#A3A4A1', brightRed: '#EF2929', brightGreen: '#8AE234', brightYellow: '#FCE94F',
  ...
  },
  {
    ...
    id: 'turbo-pascal', name: 'Turbo Pascal', theme: {
      background: '#0000AA', foreground: '#EAEAEA', cursor: '#FFFFFF', cursorAccent: '#0000AA',
      black: '#000000', red: '#AA0000', green: '#00AA00', yellow: '#AA5500',
      blue: '#0000AA', magenta: '#AA00AA', cyan: '#00AAAA', white: '#AAAAAA',
      brightBlack: '#BDBDBD', brightRed: '#FF5555', brightGreen: '#55FF55', brightYellow: '#FFFF55',
  ...
  },
  {
    ...
    id: 'solarized-light', name: 'Solarized Light', theme: {
      background: '#FDF6E3', foreground: '#262C2E', cursor: '#586E75', cursorAccent: '#FDF6E3',
      black: '#073642', red: '#DC322F', green: '#859900', yellow: '#B58900',
      blue: '#268BD2', magenta: '#D33682', cyan: '#2AA198', white: '#EEE8D5',
  ...
  },
  {
    ...
    id: 'tomorrow', name: 'Tomorrow (Light)', theme: {
      background: '#FFFFFF', foreground: '#202020', cursor: '#4D4D4C', cursorAccent: '#FFFFFF',
      black: '#000000', red: '#C82829', green: '#718C00', yellow: '#EAB700',
      blue: '#4271AE', magenta: '#8959A8', cyan: '#3E999F', white: '#FFFFFF',
      brightBlack: '#585957', brightRed: '#C82829', brightGreen: '#718C00', brightYellow: '#EAB700',
  ...
  },
  {
    ...
    id: 'sunset', name: 'Sunset', theme: {
      background: '#3B2C35', foreground: '#FCF8F2', cursor: '#FFB37A', cursorAccent: '#3B2C35',
      black: '#2B1F28', red: '#E8533D', green: '#8FB573', yellow: '#F2C14E',
      blue: '#5C6FA8', magenta: '#C25B8B', cyan: '#6FA8A0', white: '#D9C7B8',
      brightBlack: '#C2BCBF', brightRed: '#FF7A5C', brightGreen: '#B5D99C', brightYellow: '#FFDD7E',
      brightBlue: '#7E94D1', brightMagenta: '#E07FB0', brightCyan: '#93D1C8', brightWhite: '#FAF0E1',
    },
  },
  {
    // Original "Sunrise" palette designed for this app — 5am pre-dawn sky:
    // a clearly saturated deep indigo-violet (not just a tinted near-black —
    // it should actually read as "sky", not "gray"), still dark and not yet
    // bright, with the same warm accent-color family (oranges/corals/ambers)
    // as the dusky "Sunset" scheme above. `black` is deliberately kept close
    // to the background (standard ANSI-theme convention — see every other
    // dark scheme in this file); every other color was verified
    // programmatically to clear WCAG AA (>=4.5:1) against the background
    // (docs/guides/001-terminal-color-contrast.md).
    id: 'sunrise', name: 'Sunrise', theme: {
      background: '#241C46', foreground: '#F5E9DC', cursor: '#FFB37A', cursorAccent: '#241C46',
      black: '#1A1436', red: '#DC645A', green: '#7FA35C', yellow: '#E3A83D',
      blue: '#6C8FC7', magenta: '#D9709A', cyan: '#4FADA0', white: '#D9C7B8',
      brightBlack: '#AFAAC3', brightRed: '#F17D74', brightGreen: '#9BC17C', brightYellow: '#F5C065',
      brightBlue: '#8DAAD9', brightMagenta: '#E68FB2', brightCyan: '#72C4B8', brightWhite: '#FBF3E9',
    },
  },
  {
    // Tokyo Night (enkia) — palette via Tabby's community-color-schemes collection.
    id: 'tokyo-night', name: 'Tokyo Night', theme: {
      background: '#1A1B26', foreground: '#EFF2FD', cursor: '#C0CAF5', cursorAccent: '#1A1B26',
      black: '#15161E', red: '#F7768E', green: '#9ECE6A', yellow: '#E0AF68',
      blue: '#7AA2F7', magenta: '#BB9AF7', cyan: '#7DCFFF', white: '#A9B1D6',
      brightBlack: '#A2A6B5', brightRed: '#F7768E', brightGreen: '#9ECE6A', brightYellow: '#E0AF68',
  ...
  },
  {
    ...
    id: 'tokyo-night-day', name: 'Tokyo Night Day', theme: {
      background: '#E1E2E7', foreground: '#1B253D', cursor: '#3760BF', cursorAccent: '#E1E2E7',
      black: '#E9E9ED', red: '#F52A65', green: '#587539', yellow: '#8C6C3E',
      blue: '#2E7DE9', magenta: '#9854F1', cyan: '#007197', white: '#6172B0',
      brightBlack: '#464855', brightRed: '#F52A65', brightGreen: '#587539', brightYellow: '#8C6C3E',
  ...
  },
  {
    ...
    id: 'rose-pine', name: 'Rosé Pine', theme: {
      background: '#191724', foreground: '#F7F7FC', cursor: '#555169', cursorAccent: '#191724',
      black: '#26233A', red: '#EB6F92', green: '#31748F', yellow: '#F6C177',
      blue: '#9CCFD8', magenta: '#C4A7E7', cyan: '#EBBCBA', white: '#E0DEF4',
      brightBlack: '#A4A1B3', brightRed: '#EB6F92', brightGreen: '#31748F', brightYellow: '#F6C177',
  ...
  },
  {
    ...
    id: 'rose-pine-dawn', name: 'Rosé Pine Dawn', theme: {
      background: '#FAF4ED', foreground: '#23212B', cursor: '#9893A5', cursorAccent: '#FAF4ED',
      black: '#F2E9DE', red: '#B4637A', green: '#286983', yellow: '#EA9D34',
      blue: '#56949F', magenta: '#907AA9', cyan: '#D7827E', white: '#575279',
      brightBlack: '#545166', brightRed: '#B4637A', brightGreen: '#286983', brightYellow: '#EA9D34',
  ...
  },
  {
    ...
    id: 'night-owl', name: 'Night Owl', theme: {
      background: '#011627', foreground: '#F5F7FA', cursor: '#80A4C2', cursorAccent: '#011627',
      black: '#011627', red: '#EF5350', green: '#22DA6E', yellow: '#ADDB67',
      blue: '#82AAFF', magenta: '#C792EA', cyan: '#21C7A8', white: '#FFFFFF',
      brightBlack: '#A0A0A0', brightRed: '#EF5350', brightGreen: '#22DA6E', brightYellow: '#FFEB95',
  ...
  },
  {
    ...
    id: 'github', name: 'GitHub', theme: {
      background: '#F4F4F4', foreground: '#1C1C1C', cursor: '#3F3F3F', cursorAccent: '#F4F4F4',
      black: '#3E3E3E', red: '#970B16', green: '#07962A', yellow: '#F8EEC7',
      blue: '#003E8A', magenta: '#E94691', cyan: '#89D1EC', white: '#FFFFFF',
      brightBlack: '#525252', brightRed: '#DE0000', brightGreen: '#87D5A2', brightYellow: '#F1D007',
  ...
  },
  {
    ...
    id: 'material-dark', name: 'Material Dark', theme: {
      background: '#232322', foreground: '#F9F9F9', cursor: '#16AFCA', cursorAccent: '#232322',
      black: '#212121', red: '#B7141F', green: '#457B24', yellow: '#F6981E',
      blue: '#134EB2', magenta: '#560088', cyan: '#0E717C', white: '#EFEFEF',
      brightBlack: '#ADADAD', brightRed: '#E83B3F', brightGreen: '#7ABA3A', brightYellow: '#FFEA2E',
  ...
  },
  {
    ...
    id: 'argonaut', name: 'Argonaut', theme: {
      background: '#0E1019', foreground: '#FFFEFC', cursor: '#FF0018', cursorAccent: '#0E1019',
      black: '#232323', red: '#FF000F', green: '#8CE10B', yellow: '#FFB900',
      blue: '#008DF8', magenta: '#6D43A6', cyan: '#00D8EB', white: '#FFFFFF',
      brightBlack: '#9E9E9E', brightRed: '#FF2740', brightGreen: '#ABE15B', brightYellow: '#FFD242',

...
describe('nodeRegistryPayload', () => {
  const model: CanvasModel = {
    nodes: [
      { terminalId: 'tm-1', tabId: 'tb-a', paneId: 'p1', title: 'build', shellType: 'pwsh', rect: at(0, 0), isRunning: false, hasUnseenOutput: false, groupTitle: 'Group', exited: false },
      { terminalId: 'tm-2', tabId: 'tb-a', paneId: 'p2', title: 'test', shellType: 'pwsh', rect: at(0, 0), isRunning: false, hasUnseenOutput: false, groupTitle: 'Group', exited: false },
      { terminalId: 'tm-3', tabId: 'tb-b', paneId: 'p3', title: 'logs', shellType: 'bash', rect: at(0, 0), isRunning: false, hasUnseenOutput: false, groupTitle: 'Group', exited: false },
    ],
    groups: [
